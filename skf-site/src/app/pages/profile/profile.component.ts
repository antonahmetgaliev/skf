...
@Component({
  ...
  imports: [DatePipe, DecimalPipe, FormsModule, InputDirective, BadgeComponent, BtnComponent, CardComponent, FormFieldComponent, ModalComponent, PageLayoutComponent, SpinnerComponent],
